...
export function AdminNav({ displayName, email, publicSiteUrl, children }: AdminNavProps) {
  ...
  const currentSection =
    NAV_ITEMS.find(({ href }) => (href === "/admin" ? pathname === "/admin" : pathname.startsWith(href)))?.label ||
    "Workspace";
              ...
              {profileOpen && (
                ...
                >
                  <div className="dropdown-user-info">
                    ...
                    <div style={{ fontSize: "11px", color: "var(--muted)", marginTop: "4px", overflowWrap: "anywhere" }}>
                      Account: {email}
                    </div>
                  </div>
